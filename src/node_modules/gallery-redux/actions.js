...
const types = {
  ...
  SET_GALLERY_DESCRIPTION: 'SET_GALLERY_DESCRIPTION',
...
function setGalleryName(name) {
  return {
    type: types.SET_GALLERY_NAME,
    name
  }
}

function setGalleryDescription(galleryDescription) {
  return {
    type: types.SET_GALLERY_DESCRIPTION,
    galleryDescription
  }
}
  ...
  return function (dispatch) {
    ...
    return fetch(addrToFetch)
      ...
      .then(json => {
        ...
        dispatch(setGalleryDescription(json.description))
        dispatch(saveImgAddrs(json))
        dispatch(setGalleryName(json.name))
